...
$definitions['<strong>Delete</strong> all conversations forever.'] = '<strong>Delete</strong> all conversations permanently.';
...
$definitions['Delete Member'] = 'Delete Member';
$definitions['<strong>Delete this member\'s posts.</strong> All of this member\'s posts will be marked as deleted, but will be able to be restored manually.'] = '<strong>Delete this member\'s posts.</strong> All of this member\'s posts will be marked as deleted, but can be restored manually.';
...
$definitions['Don\'t allow other users to see when I am online'] = 'Do not allow other users to see when I am online';
...
$definitions['Don\'t repeat'] = 'Do not repeat.';
$definitions['Don\'t require users to confirm their account'] = 'Do not require users to confirm their account.';
...
$definitions['Email me when I\'m added to a private conversation'] = 'Email me when I am added to a private conversation';
$definitions['Email me when someone mentions me in a post'] = 'Email me when I am mentioned in a post';
$definitions['Email me when someone posts in a channel I have followed'] = 'Email me when someone posts in a channel I follow';
$definitions['Email me when someone posts in a conversation I have followed'] = 'Email me when someone posts in a conversation I follow';
$definitions['Email me when there is a new post by a member I have followed'] = 'Email me when there is a new post by a member I follow';
...
$definitions['Fatal Error'] = 'An error occurred';
...
$definitions['See the private conversations I\'ve had with %s'] = 'View the private conversations I\'ve had with %s';
...
$definitions['Use friendly URLs'] = 'Use user-friendly URLs';
...
$definitions['We\'ve logged you in and taken you straight to your forum\'s administration panel. You\'re welcome.'] = 'We\'ve logged you in and taken you directly to your forum\'s administration panel. You\'re welcome.';
...
$definitions['message.404'] = 'Sorry — the page you requested could not be found. Please go back and click a different link, or try something else.';
$definitions['message.accountNotYetApproved'] = 'The administrator has not yet approved your account. Please be patient.';
...
$definitions['message.confirmLeave'] = 'You have made changes on this page which have not yet been saved. If you navigate away from this page, you wil lose these changes. Would you like to continue regardless?';
...
$definitions['message.emailConfirmed'] = 'Cool! Your account has been validated and you can now start participating in conversations. Why not <a href=\'conversation/start\'>start one</a> yourself?';
...
$definitions['message.empty'] = 'Please fill out this field.';
$definitions['message.emptyPost'] = 'Please enter some text in your post.';
$definitions['message.emptyTitle'] = 'The title of your conversation cannot be blank.';
...
$definitions['message.esoTalkUpdateAvailableHelp'] = 'It is recommended to always run the latest version of esoTalk to reduce security risks. There may also be some new features.';
$definitions['message.esoTalkUpToDate'] = 'Your version of esoTalk is up to date.';
$definitions['message.esoTalkUpToDateHelp'] = 'esoTalk is developed in the spare time of a student. Please consider <a href=\'%s\' target=\'_blank\'>donating</a> to support its ongoing development.';
$definitions['message.fatalError'] = 'esoTalk has encountered a fatal error. Please try again, or <a href=\'%1$s\' target=\'_blank\'>get help</a>.';
$definitions['message.fileUploadFailed'] = 'Something went wrong, and the file you selected could not be uploaded. Perhaps it is too large or in an unsupported format?';
...
$definitions['message.fileUploadNotImage'] = 'The file you uploaded is not an image in an accepted format.';
$definitions['message.fileUploadTooBig'] = 'The selected file could not be uploaded because it is too large.';
$definitions['message.forgotPasswordHelp'] = 'You forgot your password. Don\'t worry - this happens. Please enter your email address and we will send you instructions to reset it.';
$definitions['message.fulltextKeywordWarning'] = 'Note that keywords shorter than 4 characters, and common English words such as \'the\' and \'for\', are not included in the search criteria.';
$definitions['message.gambitsHelp'] = 'Gambits are phrases that describe what you are looking for. Click a gambit to insert it into the search field. Double-click a gambit to search for it instantly. Normal search keywords also work.';
$definitions['message.gdNotEnabledWarning'] = '<strong>The GD extension is not enabled.</strong> This is required to resize and save avatars. Please ask your host or administrator to install/enable it.';
$definitions['message.greaterMySQLVersionRequired'] = '<strong>You must have MySQL 5.7+ or MariaDB 10.3+ installed and the <code>pdo_mysql</code> extension enabled.</strong> Please install or upgrade both requirements, or ask your host or administrator to install them.';
$definitions['message.greaterPHPVersionRequired'] = '<strong>Your server must have PHP %s or greater installed to run esoTalk.</strong> Please upgrade your PHP installation or ask your host or administrator to upgrade the server.';
$definitions['message.incorrectLogin'] = 'The login details you entered are incorrect.';
...
$definitions['message.logInToSeeAllConversations'] = '<a href=\'user/login\' class=\'link-login\'>Log in</a> to expose some channels/conversations that may be hidden to guests.';
...
$definitions['message.noPermissionToReplyInChannel'] = 'You do not have permission to reply to conversations in this channel.';
...
$definitions['message.notWritable'] = '<code>%s</code> is not writable. Try <code>chmod</code>ing it to <code>777</code>, or if it doesn\'t exist, <code>chmod</code> the folder it is contained within.';
$definitions['message.pageNotFound'] = 'The page you are looking for could not be found.';
$definitions['message.passwordChanged'] = 'Your password has been changed. You can now log in. Please remember it for future reference.';
$definitions['message.passwordEmailSent'] = 'Okay, we have sent you an email with a link to reset your password. If you do not receive it within a couple of minutes, please check your spam folder. Sometimes messages are mistakenly marked as spam.';
$definitions['message.passwordsDontMatch'] = 'The passwords do not match.';
$definitions['message.passwordTooShort'] = 'The password is too short.';
...
$definitions['message.pluginUninstalled'] = 'The plugin has been uninstalled.';
$definitions['message.postNotFound'] = 'The post you are looking for could not be found.';
$definitions['message.postTooLong'] = 'Your post is too long. The maximum number of characters allowed is %s.';
$definitions['message.preInstallErrors'] = 'These errors must be resolved before you can continue with the installation.';
$definitions['message.preInstallWarnings'] = 'You may continue the esoTalk installation without resolving these warnings, but some esoTalk functionality may be limited.';
$definitions['message.reduceNumberOfGambits'] = 'Reduce the number of gambits or search keywords you use to broaden the range of conversations.';
$definitions['message.registerGlobalsWarning'] = '<strong>PHP\'s register_globals setting is enabled.</strong> While esoTalk can run with this setting enabled, it is recommended that it be disabled to enhance security and prevent problems with esoTalk.';
$definitions['message.registrationClosed'] = 'Registration for this forum is not open to the public.';
$definitions['message.removeDirectoryWarning'] = 'Hello. It appears you have not deleted the <code>%s</code> directory as advised. Please delete it to help prevent unauthorized access.';
$definitions['message.safeModeWarning'] = '<strong>Safe mode is enabled.</strong> This may cause problems for esoTalk, but you can proceed if you are unable to disable it.';
$definitions['message.searchAllConversations'] = 'Search for this term across all conversations.';
$definitions['message.setNewPassword'] = 'Please enter your new password.';
$definitions['message.skinUninstalled'] = 'The skin has been uninstalled.';
$definitions['message.suspended'] = '<strong>suspended</strong> your account. This may limit your ability to participate until the suspension is lifted. We apologize for the inconvenience.';
$definitions['message.suspendMemberHelp'] = 'Suspending %s will prevent them from replying to conversations, starting new conversations, and viewing private conversations. They will effectively have the same permissions as a guest.';
$definitions['message.tablePrefixConflict'] = 'The installer has detected another esoTalk installation in the same MySQL database with the same table prefix.<br>• To overwrite this installation, click \'Install\' again. <strong>All data will be lost.</strong><br>• To create a new installation alongside this one, change the table prefix.';
$definitions['message.unsuspendMemberHelp'] = 'Unsuspending %s will restore their ability to participate in conversations on this forum.';
$definitions['message.upgradeSuccessful'] = 'esoTalk has been successfully upgraded.';
$definitions['message.waitForApproval'] = 'Before you can begin using your newly created account, an administrator must approve it. We will email you once it has been approved.';
$definitions['message.waitToReply'] = 'You must wait at least %s seconds between starting or replying to conversations. Please wait and try again.';
$definitions['message.waitToSearch'] = 'Please slow down. It appears you are attempting too many searches. Wait %s seconds and try again.';
$definitions['email.header'] = '<p>Hello %s!</p>';
$definitions['email.footer'] = '<p>If you prefer not to receive these kinds of emails in the future, you can <a href=\'%s\'>change your notification preferences</a>.</p>';
...
$definitions['gambit.active today'] = 'Active today';
$definitions['gambit.active 1 day'] = 'Active 1 day';
...
$definitions['gambit.last'] = 'last';
$definitions['gambit.active'] = 'active';
$definitions['gambit.gambitActive'] = '/^active *(?<a>>|<|>=|<=|last)? *(?<b>\\d+) *(?<c>second|minute|hour|day|week|month|year)/';
$definitions['gambit.active last ? hours'] = 'active last ? hours';
$definitions['gambit.active last ? days'] = 'active last ? days';
...
$definitions['Number of tags shown in the classic tag cloud; use 0 to disable it.'] = 'Number of tags displayed in the classic tag cloud; use 0 to disable it.';
$definitions['Avatar thumbnails'] = 'Avatar thumbnails';
$definitions['Show small avatar thumbnails in lists and activity.'] = 'Display small avatar thumbnails in lists and activity.';
