...
$definitions["message.greaterMySQLVersionRequired"] = "<strong>You must have MySQL 5.7+ or MariaDB 10.3+ installed and the <code>pdo_mysql</code> extension enabled.</strong> Please install/upgrade both of these requirements or request that your host or administrator install them.";
...
$definitions["Shown under your posts. Keep it short."] = "Shown under your posts. Keep it short.";
$definitions["Enter words to filter, one per line."] = "Enter words to filter, one per line.";
$definitions["Replacement"] = "Replacement";

$definitions["Copy link"] = "Copy link";
$definitions["Link copied"] = "Link copied";
$definitions["Flag"] = "Flag";
$definitions["Already flagged"] = "Already flagged";
$definitions["Thanks for the report"] = "Thanks for the report";
$definitions["Solution"] = "Solution";
$definitions["Mark as solution"] = "Mark as solution";
$definitions["Unmark solution"] = "Unmark solution";

$definitions["Color"] = "Color";

$definitions["Channel color (hex). Leave empty for default."] = "Channel color (hex). Leave empty for default.";

$definitions["Post color"] = "Post color";

$definitions["Choose a color for your posts (classic esoTalk style)."] = "Choose a color for your posts (classic esoTalk style).";

$definitions["Blog"] = "Blog";

$definitions["No blog posts yet."] = "No blog posts yet.";

$definitions["Dark mode"] = "Dark mode";

$definitions["Light"] = "Light";

$definitions["Dark"] = "Dark";

$definitions["System default"] = "System default";

$definitions["Ignore"] = "Ignore";

$definitions["Unignore"] = "Unignore";

$definitions["Post hidden — you ignore this member."] = "Post hidden — you ignore this member.";

$definitions["Views"] = "Views";

$definitions["Skip to content"] = "Skip to content";

$definitions["Main menu"] = "Main menu";

$definitions["User menu"] = "User menu";
$definitions["Manage Blog"] = "Manage Blog";
$definitions["New post"] = "New post";
$definitions["Edit post"] = "Edit post";
$definitions["Post created!"] = "Post created!";
$definitions["Post deleted."] = "Post deleted.";
$definitions["Published"] = "Published";
$definitions["Draft"] = "Draft";
$definitions["Actions"] = "Actions";
$definitions["All"] = "All";
$definitions["My statuses"] = "My statuses";
$definitions["Post a status"] = "Post a status";
...
$definitions["Back to %s"] = "Back to %s";
$definitions["Choose a Channel"] = "Choose a Channel";
$definitions["Code"] = "Code";
$definitions["Confirm Password"] = "Confirm Password";
$definitions["Content"] = "Content";
$definitions["Date"] = "Date";
$definitions["Delete this post"] = "Delete this post";
$definitions["Go Back"] = "Go Back";
$definitions["Home"] = "Home";
$definitions["Image"] = "Image";
$definitions["Italic"] = "Italic";
$definitions["Languages"] = "Languages";
$definitions["Leave blank to generate from title"] = "Leave blank to generate from title";
...
$definitions["MySQL Table Prefix"] = "MySQL Table Prefix";
$definitions["MySQL Username"] = "MySQL Username";
$definitions["Newer"] = "Newer";
$definitions["No news available."] = "No news available.";
$definitions["No status updates yet."] = "No status updates yet.";
$definitions["Normal"] = "Normal";
$definitions["Older"] = "Older";
$definitions["Online Members"] = "Online Members";
$definitions["Page loaded in %s seconds"] = "Page loaded in %s seconds";
$definitions["Port"] = "Port";
$definitions["Post"] = "Post";
$definitions["Post not found"] = "Post not found";
$definitions["Primary color"] = "Primary color";
$definitions["Privacy"] = "Privacy";
$definitions["Quick links"] = "Quick links";
$definitions["SSL"] = "SSL";
$definitions["Server"] = "Server";
$definitions["Slug already in use or database error."] = "Slug already in use or database error.";
$definitions["Status"] = "Status";
$definitions["Status deleted."] = "Status deleted.";
$definitions["Strike"] = "Strike";
$definitions["TLS"] = "TLS";
$definitions["Try Again"] = "Try Again";
$definitions["Upgrade Now"] = "Upgrade Now";
$definitions["Upload image"] = "Upload image";
$definitions["Version %s"] = "Version %s";
$definitions["Viewing %s"] = "Viewing %s";
$definitions["Welcome to esoTalk"] = "Welcome to esoTalk";
$definitions["You do not have permission to start conversations in this channel."] = "You do not have permission to start conversations in this channel.";
$definitions["deleted"] = "deleted";
$definitions["hidden"] = "hidden";
$definitions["%d hidden"] = "%d hidden";
$definitions["%s Members"] = "%s Members";
$definitions["%s others"] = "%s others";
$definitions["News feed is disabled."] = "News feed is disabled.";
$definitions["Flagged posts"] = "Flagged posts";
$definitions["Upload failed"] = "Upload failed";
$definitions["Copy"] = "Copy";
$definitions["Copied"] = "Copied";

$definitions["message.loginThrottled"] = "Too many login attempts. Please wait a few minutes and try again.";
$definitions["loginThrottled"] = "Too many login attempts. Please wait a few minutes.";

// Classic v1 branding compatibility.
$definitions["Forum description"] = "Forum description";
$definitions["Classic description options"] = "Classic description options";
$definitions["The description shown below the forum title on the conversation list."] = "The description shown below the forum title on the conversation list.";
$definitions["Show the forum description in the header"] = "Show the forum description in the header";
$definitions["Use the forum description as the meta description"] = "Use the forum description as the meta description";
$definitions["Upload a logo"] = "Upload a logo";
$definitions["Use a logo URL"] = "Use a logo URL";
$definitions["Use the default header"] = "Use the default header";
$definitions["Forum icon"] = "Forum icon";
$definitions["Used for the favicon, Apple Touch icon and social sharing image."] = "Used for the favicon, Apple Touch icon and social sharing image.";
$definitions["Upload an icon"] = "Upload an icon";
$definitions["Use an icon URL"] = "Use an icon URL";
$definitions["Use the built-in compatibility icon"] = "Use the built-in compatibility icon";
$definitions["Favicon"] = "Favicon";
$definitions["Upload a favicon"] = "Upload a favicon";
$definitions["Use a favicon URL"] = "Use a favicon URL";
$definitions["Use the forum icon"] = "Use the forum icon";
$definitions["message.invalidImageURL"] = "Please enter a valid HTTP(S) image URL.";
$definitions["Started by"] = "Started by";
$definitions["Last reply"] = "Last reply";
$definitions["Use the classic conversation list"] = "Use the classic conversation list";
$definitions["Upload an avatar"] = "Upload an avatar";
$definitions["Use an avatar URL"] = "Use an avatar URL";
$definitions["Use no avatar"] = "Use no avatar";
$definitions["message.invalidAvatarURL"] = "Please enter a valid HTTP(S) avatar URL.";
$definitions["Message display time"] = "Message display time";
$definitions["Amount of time before auto-dismissable messages disappear."] = "Amount of time before auto-dismissable messages disappear.";
$definitions["message.invalidMessageDisplayTime"] = "Please enter a number of seconds greater than zero.";
$definitions["Tag cloud size"] = "Tag cloud size";
$definitions["tags"] = "tags";
$definitions["Number of tags shown in the classic tag cloud; use 0 to disable it."] = "Number of tags shown in the classic tag cloud; use 0 to disable it.";
$definitions["Avatar thumbnails"] = "Avatar thumbnails";
$definitions["Show small avatar thumbnails in lists and activity."] = "Show small avatar thumbnails in lists and activity.";
