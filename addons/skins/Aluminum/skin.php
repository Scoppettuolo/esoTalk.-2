 ...
 */
// Aluminum-inspired skin adapted from esoTalk v1 for the modern v2 markup.
if (!defined("IN_ESOTALK")) exit;

ET::$skinInfo["Aluminum"] = array(
    "name" => "Aluminum",
    "description" => "The classic silver esoTalk skin adapted for esoTalk 2.",
...
class ETSkin_Aluminum extends ETSkin {
