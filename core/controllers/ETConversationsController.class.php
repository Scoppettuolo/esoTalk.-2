...
public function action_index($channelSlug = false)
{
	...
	if ($this->responseType === RESPONSE_TYPE_DEFAULT) {
		...
		if (!$description && C("esoTalk.metaDescription", false)) $description = C("esoTalk.forumDescription", "");
		if (!$description) $description = sprintf(T("forumDescription"), C("esoTalk.forumTitle"), implode(", ", $keywords), $lastKeyword);
...
protected function getSelectedChannels($channelSlug = "")
{
	...
	$channelInfo = ET::channelModel()->getByPermission();
