...
{
	// esoTalk.org is offline; news feed removed.
	// Still perform the update check so the notification area works.
	ET::upgradeModel()->checkForUpdates();
	$this->json("updateNotification", $this->getViewContents("admin/updateNotification"));
	$this->json("html", "<p class=\"help\">".T("No news available.")."</p>");
	$this->renderJSON();
}
