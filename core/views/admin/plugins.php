...
<li><span><i class='icon-user'></i><?php
$author = !empty($plugin["info"]["author"]) ? $plugin["info"]["author"] : "Unknown";
$authorURL = !empty($plugin["info"]["authorURL"]) ? $plugin["info"]["authorURL"] : "#";
printf(T("By %s"), "<a href='".sanitizeHTML($authorURL)."'>".sanitizeHTML($author)."</a>");
?></span></li>
